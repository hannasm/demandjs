...
selector:"img,video,iframe,link.demand"},a);this.mutation=new MutationObserver(function(a,c){return d.observeMutation(a,c)});this.mutationOptions={childList:!0,subtree:!0};this.intersectionOptions={root:null,rootMargin:"48px",threshold:.1};this.intersection=new IntersectionObserver(function(a,c){return d.observeIntersection(a,c)},this.intersectionOptions);this.observeTargets(this.queryTargets());this.mutation.observe(document.body,this.mutationOptions)}_createClass(c,[{key:"observeMutation",value:function(a){var d=
